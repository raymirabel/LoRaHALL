...
void commandLine(void){
  cmd.begin(Serial, F("LoRaHALL>"), welcome);
  ...
  while(1){
    ...
    cmd.task();
    //While the programmer is connected, the LED TEST is activated depending on the HALL sensor.
    //This way you can test the best position for the magnet...
    digitalWrite(LED, digitalRead(HALL_INT));
  }
}
